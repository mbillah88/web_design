...
class Command(BaseCommand):
    ...
    def setup_diagnostics(self):
        ...
        subcategories = [
            ...
            ("Immunological Test", "Pathology", "অটোইমিউন ও অ্যালার্জি পরীক্ষা"),
            ("Hormone Test", "Pathology", "Hormone Test পরীক্ষা"),
        ...
        groups = [
            ...
            ("Anti HAV - (IgM)", "Biochemical", 1000, 900, 10),
        ...
        groups += [
            ("Anti Thyroid Antibody (Anti TPO + Anti TG)", "Immunological Test", 2400, 2160, 10),
            ("Blood Grouping and Cross Matching", "Immunological Test", 1000, 1000, 0),
            ("CA-125", "Immunological Test", 1200, 1080, 10),
            ("PTH (Para Thyroid Hormone)", "Immunological Test", 1500, 1350, 10),
            ("25 (OH) Vitamin D", "Immunological Test", 3000, 2700, 10),
            ("PTH", "Immunological Test", 1500, 1350, 10),
            ("Beta-hCG", "Immunological Test", 1200, 1080, 10),
            ("Anti Hbs Ag Titre", "Immunological Test", 1200, 1080, 10), 
            ("Anti-acetylcholine receptor (AChR)", "Immunological Test", 3570, 3213, 10), 
            ("Anti- Muscle-Kinase(Anti MuSK)", "Immunological Test", 3500, 3150, 10), 
            ("ENA Profile", "Immunological Test", 8000, 7200, 10), 
            ("Blood Coomb's test", "Immunological Test", 1500, 1350, 10), 
            ("Anti Hbc IgM", "Immunological Test", 1200, 1080, 10),
            ("Anti TPO", "Immunological Test", 1200, 1080, 10), 
            ("Anti TG", "Immunological Test", 1200, 1080, 10),
        ]
        groups += [
            ("S.Oestrogen / Estradiol / Estrogen", "Hormone Test", 1200, 1080, 10),
            ("C3", "Hormone Test", 1200, 1080, 10),
            ("S.Magnesium", "Hormone Test", 1200, 1080, 10),
            ("S.Copper", "Hormone Test", 2500, 2250, 10),
        ]
        groups += [
        ...
        # Step 4: Test Items
        items = [
            ("ACTH", "ACTH", "pg/mL", "10–60"),
            ("Alkaline Phosphatase", "Alkaline Phosphatase", "U/L", "44–147"),
            ("Alpha Feto Protein", "Alpha Feto Protein", "ng/mL", "<10"),
            ("ANF", "ANF", "Ratio", "<1:40"),
            ("Anti Cardiolipin AB IgG,IgM", "Anti Cardiolipin AB IgG,IgM", "GPL/MPL", "<15"),
            ("Anti CCP", "Anti CCP", "U/mL", "<20"),
            ("Anti DNA (ELISA)", "Anti DNA(ELISA)", "IU/mL", "<30"),
            ("Anti DS DNA", "Anti DS DNA", "IU/mL", "<30"),
            ("Triglyceride", "Tryglyceride (TG)", "mg/dL", "<150"),
            ("Anti HAV IgM", "Anti HAV - (IgM)", "IU/mL", "Negative"),
            ("Anti HBc", "Anti HBc", "IU/mL", "Negative"),
            ("TSH", "TSH (ELISA)", "µIU/mL", "0.4–4.0"),
            #("Urine Amylase", "U/R For Amylase", "U/L", "0–450"),
            #("Urethral Gram Stain", "Urethral Discharge for Gram -stain", "Result", "No organism seen"),
            #("Urethral C/S", "Urethral Mas C/S", "Result", "No growth"),
            ("APTT", "APTT", "seconds", "25–35"),
            ("Urine C/S", "Urine For C/S", "Result", "No growth"),
            #("Urine Coagulation", "Urine for Gagulation", "Result", "Negative"),
            #("Urine Microalbumin", "Urine For Mycro-Albumin", "mg/L", "<30"),
            #("Blood Film", "Blood Film", "Result", "No abnormal cell"),
            ("LDH", "Blood For LDH", "U/L", "140–280"),
            #("Urine Reducing Substance", "Urine For Reducing Substance", "Result", "Negative"),
            ("Urine R/E", "Urine R/E", "Result", "Normal"),
            ("Blood Urea", "Blood Urea", "mg/dL", "10–50"),
        ]
        items += [
            ("Urinary Total Volume", "UTV (Urinary Total Volume)", "mL", "1000–2000"),
            ("Butterfly Needle", "Buter Fly Needle.", "pcs", "Used"),
            ("Ascitic Fluid C/S", "C/S For Ascitic Fluid", "Result", "No growth"),
            ("Gram Stain C/S", "C/S For Gram Stain", "Result", "No organism seen"),
            ("Discharge C/S", "C/S of Discharge", "Result", "No growth"),
            ("Wound Swab C/S", "Wound Swab For C/S", "Result", "No growth"),
            ("HbsAg Confirmatory", "Hbs-Ag (Confirmatory)", "IU/mL", "Negative"),
            ("Creatinine Clearance Rate", "CCR(Creatinin clearance Rate)", "mL/min", "90–120"),
            ("CSF Biochemical", "CFS-Biochemical", "Result", "Normal"),
            ("Random Lipid Profile", "Random Lipid Profile (Four Test)", "mg/dL", "See individual tests"),
            ("CK-MB", "CK-MB", "ng/mL", "<5"),
            ("CPK", "CPK", "U/L", "10–120"),
            ("D-Dimer", "D-Dimer", "ng/mL", "<500"),
            ("Cortisol (PM)", "S.Cortisol (PM)", "µg/dL", "3–10"),
            ("ACR", "ACR", "mg/g", "<30"),
            ("CSF Culture", "CSF C/S", "Result", "No growth"),
            ("DC (Differential Count)", "DC", "%", "Neut 40–75, Lymph 20–45"),
            ("Testosterone", "Estimation of testostoren", "ng/dL", "300–1000"),
        ]
        items += [
            ("FSH", "FSH (ELISA)", "mIU/mL", "1.5–12.4"),
            ("FT3", "FT3 (ELISA)", "pg/mL", "2.0–4.4"),
            ("FT4", "FT4 (ELISA)", "ng/dL", "0.93–1.7"),
            ("GTT (3 Samples)", "GTT (3 Samples)", "mmol/L", "See curve"),
            ("GTT (5 Samples)", "GTT (5 Samples)", "mmol/L", "See curve"),
            ("S.Copper", "S.Copper", "µg/dL", "70–140"),
            ("Growth Hormone", "Growth Hormone", "ng/mL", "<10"),
            ("Anti Phospholipid Ab IgG,IgM", "Anti Phospolied Ab IgG,IgM", "GPL/MPL", "<15"),
            ("Blood Culture", "Blood C/S", "Result", "No growth"),
            ("HbA1c", "HBA1C", "%", "<5.7"),
            ("Anti HCV (ELISA)", "Anti HCV (ELISA)", "IU/mL", "Negative"),
            ("HbsAg (ELISA)", "Hbs Ag (ELISA)", "IU/mL", "Negative"),
            ("Anti Scl-70", "Anti Scl - 70", "IU/mL", "Negative"),
            ("HBV DNA (PCR)", "HBV DNA (PCR)", "copies/mL", "Not detected"),
            ("HDL Cholesterol", "HDL Cholesterol", "mg/dL", ">40"),
            ("Anti HIV", "Anti HIV", "IU/mL", "Negative"),
            ("INR", "INR", "Ratio", "0.8–1.2"),
            ("ICT for Dengue IgM/IgG", "ICT For Dangue Antibody(Igm & IgG)", "Result", "Negative"),
            ("ICT for Dengue IgM/IgG", "ICT For Dangue(IgM & igG)", "Result", "Negative"),
            ("LDL Cholesterol", "LDL Cholesterol", "mg/dL", "<100"),
            ("C-Peptide (Fasting)", "C-Peptide (Fasting)", "ng/mL", "0.5–2.0"),
            ("S.IgG", "S.IGG", "mg/dL", "700–1600"),
            ("Microprotein", "Microprotein", "mg/dL", "<150"),
            ("Microprotein Sugar", "Microprotein Sugar", "mg/dL", "<150"),
        ]
        items += [
            ("Electrolytes (Na+, K+, Cl-)", "Na+,K+, Cl-", "mmol/L", "Na: 135–145, K: 3.5–5.1, Cl: 98–107"),
            ("eGFR (Estimated Glomerular Filtration Rate)", "S. eGFR (Estimated Glomerular Filtration Rate)", "mL/min/1.73m²", ">90"),
            ("Estrogen", "Oestrogen/Estrogen", "pg/mL", "30–400"),
            ("OGTT", "OGTT", "mmol/L", "Fasting <5.6, 2hr <7.8"),
            ("P/S for C/S", "P/S for C/S", "Result", "No growth"),
            ("P/S for Gram Stain", "P/S for Gram Stain", "Result", "No organism seen"),
            ("P/S Gram Staining", "P/S For Gramstaning", "Result", "No organism seen"),
            ("NT-Pro BNP", "NT. Pro BNP", "pg/mL", "<125"),
            ("CA 15.3", "S.CA 15.3", "U/mL", "<30"),
            ("ICT Micro Filaria", "ICT Micro Filaria (Elisa)", "Result", "Negative"),
            ("Pleural Fluid Analysis", "Plural Fluid For Analysis", "Result", "Normal"),
            ("Progesterone", "Progesterone", "ng/mL", "0.1–25"),
            ("AMH", "AMH (Anti- Mullerian Hormone)", "ng/mL", "1.0–4.0"),
            ("MCHC", "MCHC", "g/dL", "32–36"),
            ("Blood for MP", "Blood For MP", "Result", "Negative"),
            ("Hemoglobin", "Hb %", "g/dL", "13.5–17.5"),
            ("Anti HBs", "Anti HBs", "IU/L", ">10"),
            ("Peripheral Blood Film", "PBF (Peripheral Blood Film Study)", "Result", "No abnormal cell"),
            ("BT, CT", "BT,CT", "minutes", "BT: 2–7, CT: 3–10"),
            ("Prolactin", "Prolactein", "ng/mL", "4.8–23.3"),
            ("TRAb", "TRAB (Tsh Receptor Antibody)", "IU/L", "<1.75"),
            ("PT", "PT (Prothrombin Time)", "seconds", "11–13.5"),
            ("Testosterone", "Testosterone", "ng/dL", "300–1000"),
            ("RA Test", "R.A Test", "IU/mL", "<14"),
            ("TCE", "TCE (Total Circulating Eosinophil)", "cells/µL", "0–450"),
            ("TC,DC,ESR", "TC,DC,ESR", "Result", "TC: 4–11k, ESR: <20"),
            ("ESR", "ESR", "mm/hr", "Male: <15, Female: <20"),
            ("H. Pylori", "H.Pylori", "Result", "Negative"),
            ("TC,DC", "TC,DC", "Result", "TC: 4–11k, DC: Normal"),
        ]
        items += [
            ("LH", "LH (ELISA)", "mIU/mL", "1.7–8.6"),
            ("Platelet Count", "Platelet Count", "x10^3/µL", "150–450"),
            ("Anti HBe (Elisa)", "Anti Hbe (Elisa)", "IU/mL", "Negative"),
            ("Anti HCV (Screening)", "Anty HCV (Screening)", "IU/mL", "Negative"),
            ("Anti H. Pylori IgG", "Anti H-Pylori IgG", "IU/mL", "Negative"),
            ("S.IgM", "S.IGM", "mg/dL", "40–230"),
            ("HLA B-27", "HLA B-27", "Result", "Negative"),
            ("Triple Antigen", "Triple Antigen", "Result", "Negative"),
            ("HCV RNA", "HCV RNA", "copies/mL", "Not detected"),
            ("Rh Antibody Titre", "Rh-antibody titre", "Ratio", "<1:8"),
            ("Urine for Ketonbody", "Urine for ketonbody", "Result", "Negative"),
            ("TPHA", "T.P.H.A.", "Result", "Negative"),
            ("S.Folic Acid", "S.Folic Acid", "ng/mL", "3–17"),
            ("Urine for PCR", "Urine for PCR", "Result", "Negative"),
            ("S.Albumin Ratio", "S.Albumin Ratio (Next)", "g/dL", "3.5–5.0"),
            ("Rubella IgM", "Rubella (IgM)", "IU/mL", "Negative"),
            ("Prostatic Smear Gram Stain", "Prostatic smear for Gram stainnig", "Result", "No organism seen"),
            ("Urine for Pregnancy", "Urine For Pregnency", "Result", "Negative"),
            ("P/S for R/E", "P/S For R/E", "Result", "Normal"),
            ("Urinary Amylase", "Urinary Amylase", "U/L", "0–450"),
            ("Anti RNP Antibody", "Anti RNP Antibody", "IU/mL", "Negative"),
            ("Toxoplasma IgG", "Seram Toxoplasma Elaisa", "IU/mL", "Negative"),
            ("H. Pylori IgG/IgM", "H.Pylori (IgG,IgM)", "IU/mL", "Negative"),
            ("ICT Filaria", "ICT-Filaria", "Result", "Negative"),
            ("VDRL (Qualitative)", "VDRL (Qualitive)", "Result", "Non-reactive"),
            ("VDRL (Quantitative)", "VDRL (Quantitive)", "titer", "<1:8"),
            ("ICT-TB", "ICT -TB", "Result", "Negative"),
            ("ICT for Malaria", "ICT For Malaria", "Result", "Negative"),
            ("Vitamin B12", "Vit B12", "pg/mL", "200–900"),
            ("Widal Test", "Widal Test", "titer", "<1:80"),
        ]
        items += [
            ("Anti HBe", "Anti HBe Ag", "IU/mL", "Negative"),
            ("Urine Electrolyte", "Urine For Electrolyte", "mmol/L", "Na: 40–220, K: 25–125"),
            ("S. Lactate", "S. Lactate", "mmol/L", "0.5–2.2"),
            ("CA 19.9", "CA 19.9", "U/mL", "<37"),
            ("HbsAg Screening", "Hbs Ag (Screening)", "IU/mL", "Negative"),
            ("Sputum for AFB (2 samples)", "Sputum For A.F.B. 2 SAMPLE", "Result", "No AFB seen"),
            ("Urine Albumin", "Urine For Albumin", "mg/dL", "<30"),
            ("Screening & Crossmatch", "Screening & Crossmatch", "Result", "Compatible"),
            ("Hb Electrophoresis", "Hb-Electrophoresis", "Result", "Normal pattern"),
            ("HBe Ag", "HBe Ag", "IU/mL", "Negative"),
            ("Anti HAV", "Anti HAV", "IU/mL", "Negative"),
            ("Dengue NS1", "Dengue NS1 (Govt fixed rate)", "Result", "Negative"),
            ("S. Lithium", "S.Lithium", "mmol/L", "0.6–1.2"),
            ("Bence-Jones Protein", "Urine For bence-jones Protein", "Result", "Negative"),
            ("Urine ACR", "Urine for ACR", "mg/g", "<30"),
            ("FNAC", "FNAC", "Result", "No malignant cell"),
            ("Fluid for C/S", "Fluid For C/S", "Result", "No growth"),
            ("Toxoplasma IgG", "Toxoplasma Gondi (IgG)", "IU/mL", "Negative"),
            ("Triple/Febrile Antigen", "Triple/Febrile Antizen", "Result", "Negative"),
            ("CSF Analysis", "CSF Analysis", "Result", "Normal"),
            ("CFT for Filaria", "CFT For Filaria", "Result", "Negative"),
            ("Blood Grouping", "Blood Grouping", "Group", "A/B/AB/O +ve/-ve"),
            ("ASO Titre", "ASO Titre", "IU/mL", "<200"),
            ("Ascitic Fluid Analysis", "Ascitic Fluid  Analysis", "Result", "Normal"),
            ("Sputum for Eosinophil", "Sputam for Eosinophil", "cells/HPF", "<5"),
            ("C4", "C4", "mg/dL", "10–40"),
            ("Anti HBe Total", "Anti HBe Total", "IU/mL", "Negative"),
            ("CSF Cytology & Biochemistry", "CSF  cytolygy, Biochemistry", "Result", "Normal"),
            ("Urine AFB (3 days)", "urine for AFB (3days)", "Result", "No AFB seen"),
            ("Biopsy (Medium)", "Biopsy (Medium) - (The Lab)", "Result", "Histopathology report"),
        ]
        items += [
            ("CSF Biochemistry", "CSF for biochemistry", "Result", "Normal"),
            ("Biopsy (Large)", "Biopsy (Large)", "Result", "Histopathology report"),
            ("Biopsy (Small)", "Biopsy (Small)", "Result", "Histopathology report"),
            ("Synovial Fluid Analysis", "Synovil Fluid Analysis", "Result", "Normal"),
            ("Biopsy (Small) - The Lab", "Biopsy (Small) - (The Lab)", "Result", "Histopathology report"),
            ("Urine Total Protein", "Total protin (Urine)", "mg/dL", "<150"),
            ("Cytology (Malignant Cell)", "S.Cytology(Malignant Cell)", "Result", "No malignant cell"),
            ("Stool C/S", "Stool C/S", "Result", "No growth"),
            ("Biopsy (Medium)", "Biopsy (Medium)", "Result", "Histopathology report"),
            ("Pap's Smear", "Pap's smear", "Result", "No abnormal cell"),
            ("Biopsy (Large) - The Lab", "Biopsy (Large) - (The Lab)", "Result", "Histopathology report"),
            ("ICT for Kala-azar", "ICT FOR Kala zar", "Result", "Negative"),
            ("Anti Mitochondrial Antibody", "Anti mitochondrial antibody", "IU/mL", "Negative"),
            ("Sputum for AFB", "Sputam for afb", "Result", "No AFB seen"),
            ("Anti HEV IgM", "Anti HEV IgM", "IU/mL", "Negative"),
            ("Toxoplasma IgM", "Toxoplasma Gondi (IgM)", "IU/mL", "Negative"),
            ("Gram Staining", "Gram Staining", "Result", "No organism seen"),
            ("MT Test (Tuberculin)", "MT Test (Tuberculin Test)", "mm", "<10"),
            ("Nail Scraping for Fungus", "Nail Scraping for fungus", "Result", "No fungus seen"),
            ("Pus for C/S", "Pus for C/S", "Result", "No growth"),
            ("Sputum for Malignancy", "Sputum  For Malignancy", "Result", "No malignant cell"),
            ("Sputum for AFB (3 samples)", "Sputum for AFB 3 Sample", "Result", "No AFB seen"),
            ("Swab for C/S", "Swab for c/s", "Result", "No growth"),
            ("Stool for OBT", "Stool for OBT", "Result", "Negative"),
            ("Stool Reducing Substance", "Stool for Reducing Substance", "Result", "Negative"),
            ("Urine for Chyle", "Urine for chyle", "Result", "Negative"),
            ("Skin Scraping for Fungus", "Skin Scraping for Fungus", "Result", "No fungus seen"),
            ("Semen Analysis", "Semen Analysis", "Result", "Normal"),
            ("Sputum C/S", "Sputam C/S", "Result", "No growth"),
            ("Anti Smooth Muscle Antibody", "Anti smooth muscle antibody", "IU/mL", "Negative"),
        ]
        items += [
            ("Anti LKM Antibody", "Anti liver kidney microsomal antibody", "IU/mL", "Negative"),
            ("Anti Thyroid Antibodies", "Anti Thyroid Antibody (Anti TPO + Anti TG)", "IU/mL", "Negative"),
            ("Blood Grouping & Crossmatch", "Blood Grouping and Cross Matching", "Result", "Compatible"),
            ("CA-125", "CA-125", "U/mL", "<35"),
            ("PTH", "PTH (Para Thyroid Hormone)", "pg/mL", "15–65"),
            ("Vitamin D (25-OH)", "25 (OH) Vitamin D", "ng/mL", "30–100"),
            ("PTH", "PTH", "pg/mL", "15–65"),
            ("Beta-hCG", "Beta-hCG", "mIU/mL", "<5 (non-pregnant)"),
            ("Anti HBs Titre", "Anti Hbs Ag Titre", "IU/L", ">10"),
            ("Anti-AChR", "Anti-acetylcholine receptor (AChR)", "nmol/L", "<0.5"),
            ("Anti-MuSK", "Anti- Muscle-Kinase(Anti MuSK)", "nmol/L", "<0.05"),
            ("ENA Profile", "ENA Profile", "Result", "Negative"),
            ("Coomb's Test", "Blood Coomb's test", "Result", "Negative"),
            ("Anti HBc IgM", "Anti Hbc IgM", "IU/mL", "Negative"),
            ("Anti TPO", "Anti TPO", "IU/mL", "<35"),
            ("Anti TG", "Anti TG", "IU/mL", "<40"),
            ("Estradiol", "S.Oestrogen / Estradiol / Estrogen", "pg/mL", "30–400"),
            ("C3", "C3", "mg/dL", "90–180"),
            ("S. Magnesium", "S.Magnesium", "mg/dL", "1.7–2.4"),
            ("S. Copper", "S.Copper", "µg/dL", "70–140"),
            ("Urine Profile", "Urine Profils", "Result", "Normal"),
            ("Stool R/E", "Stool R/E", "Result", "Normal"),
            ("CEA", "CEA (Carcinoembryonic Antigen)", "ng/mL", "<5"),
        ]
        ...
        #ABF(After Break Fast) (Blood Sugar) and Corresponding Urine Sugar
        items += [
            ("ABF(After Break Fast) (Blood Sugar)", "ABF(After Break Fast)", "mmol/L", "4.4–7.8"),
            ("Corresponding Urine Sugar", "ABF(After Break Fast)", "Result", "Nil/Trace"),
        ]
        ...
        items += [
            ("Fasting Glucose", "OGTT", "mmol/L", "<5.6"),
            ("1 Hour Glucose", "OGTT", "mmol/L", "<10.0"),
            ("2 Hour Glucose", "OGTT", "mmol/L", "<7.8"),
            ("Corresponding Urine Sugar", "OGTT", "Result", "Nil/Trace"),
        ]
        ...
        items += [
            ("Sodium (Na+)", "Na+,K+, Cl-", "mmol/L", "135–145"),
            ("Potassium (K+)", "Na+,K+, Cl-", "mmol/L", "3.5–5.1"),
            ("Chloride (Cl−)", "Na+,K+, Cl-", "mmol/L", "98–107"),
        ]
        ...
        #🧪 Microprotein Sugar
        items += [
            ("Urine Microprotein", "Microprotein Sugar", "mg/dL", "<150"),
            ("Urine Sugar", "Microprotein Sugar", "Result", "Nil/Trace"),
        ]
        #🧪 Urine for PCR
        items += [
